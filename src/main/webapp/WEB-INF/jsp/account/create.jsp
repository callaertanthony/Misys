            ...
            <div class="col-sm-4">
                <div class="signup-form"><!--sign up form-->
                    ...
                    <form:form name="form" action="" method="post" modelAttribute="form">
                        ...
                        <form:input type="email" name="email" value="${form.email}" id="email" required="true"
                                    path="email" class="form-control" placeholder="${email}"/>
                        <form:input type="password" name="password" id="password" required="true" path="password"
                                    class="form-control" placeholder="${password}"/>
                        <form:input type="password" name="passwordRepeated" id="passwordRepeated" required="true"
                                    path="passwordRepeated" class="form-control" placeholder="${repeat}"/>
                        ...
                        <form:select name="gender" id="gender" required="true" path="gender" class="form-control"
                                     placeholder="${gender}">/
                            <form:option value="MAN"><spring:message code="create.man"/></form:option>
                            <form:option value="WOMAN"><spring:message code="create.woman"/></form:option>
                        </form:select>
