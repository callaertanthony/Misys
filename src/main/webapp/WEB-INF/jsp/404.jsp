...
<head>
    ...
    <!--[if lt IE 9]>
    <script <spring:url value="/assets/js/html5shiv.js"/>></script>
    <script <spring:url value="/assets/js/respond.min.js"/>></script>
    <![endif]-->
...
<div class="container text-center">
    <div class="logo-404">
        <a href="index.html"><img <spring:url value="/assets/images/home/logo.png"/> alt=""/></a>
    </div>
